        ...
        >
            ...
            <div className="relative z-10 px-8 py-16 md:py-20 text-center">
              ...
              <div className="flex flex-col lg:flex-row gap-4 justify-center items-center flex-wrap">
                <a 
                  href={CTA_CONTENT.googlePlayUrl}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-white text-suica-dark w-full sm:w-64 px-8 py-4 rounded-xl font-bold text-lg shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-200 flex items-center justify-center gap-3"
                >
                ...
                <a 
                  href={CTA_CONTENT.apkUrl}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-gray-900 text-white w-full sm:w-64 px-8 py-4 rounded-xl font-bold text-lg shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-200 flex items-center justify-center gap-3 border border-white/10"
                >
                ...
                <a 
                  href={CTA_CONTENT.donationUrl}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-gray-900 text-white w-full sm:w-64 px-8 py-4 rounded-xl font-bold text-lg shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-200 flex items-center justify-center gap-3"
                >
