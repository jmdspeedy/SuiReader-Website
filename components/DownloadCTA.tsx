        ...
        >
            ...
            <div className="relative z-10 px-8 py-16 md:py-20 text-center">
              ...
              <div className="flex flex-col lg:flex-row gap-4 justify-center items-center flex-wrap">
                <button className="bg-white text-suica-dark w-full sm:w-64 px-8 py-4 rounded-xl font-bold text-lg shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-200 flex items-center justify-center gap-3">
                ...
                <button className="bg-gray-900 text-white w-full sm:w-64 px-8 py-4 rounded-xl font-bold text-lg shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-200 flex items-center justify-center gap-3 border border-white/10">
                  <Download className="w-5 h-5 flex-shrink-0" />
                  {CTA_CONTENT.apkBtn}
                </button>

                <button className="bg-gray-900 text-white w-full sm:w-64 px-8 py-4 rounded-xl font-bold text-lg shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-200 flex items-center justify-center gap-3">
